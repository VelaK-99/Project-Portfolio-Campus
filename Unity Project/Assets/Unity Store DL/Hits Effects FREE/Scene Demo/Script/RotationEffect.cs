...
namespace MatthewAssets
{
    ...
    {
        public ParticleSystem m_particleSystem; // Asigna el sistema de partículas en el Inspector
        ...
        {
            SetRandomRotation();
            m_particleSystem.Play(); // Inicia el sistema de partículas (opcional)
        }
        ...
        void SetRandomRotation()
        {
            ...
            m_particleSystem.transform.rotation = Quaternion.Euler(0f, 0f, randomZRotation);
        }
    }
}